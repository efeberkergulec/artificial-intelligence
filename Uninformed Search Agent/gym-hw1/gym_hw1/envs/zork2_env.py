...
class Zork2Env(discrete.DiscreteEnv):
    """
    ...
    def __init__(self, desc=None, map_name="8x8", mintreasure = 1, maxturn = 20, is_slippery=False):
        ...
        super(Zork2Env, self).__init__(nS, nA, P, isd)

    def step(self, a):
        self.tot_turns += 1
        ob, rew, done, prb = super(Zork2Env, self).step(a)
